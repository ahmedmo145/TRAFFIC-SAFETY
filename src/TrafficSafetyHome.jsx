...
import { CarFront, Construction, TrafficCone, Download, LayoutList, Mail, School } from "lucide-react";
  ...
  const content = {
    ar: {
      ...
      cards: [
        ...
        { title: "السلامة المدرسية", desc: "نصائح لضمان سلامة الطلاب والمعلمين في محيط المدارس.", icon: <School /> },
      ],
    ...
    en: {
      ...
      cards: [
        ...
        { title: "School Zone Safety", desc: "Tips to ensure safety of students and teachers around schools.", icon: <School /> },
      ],
    ...
    ur: {
      ...
      cards: [
        ...
        { title: "اسکول کی حفاظت", desc: "طلباء اور اساتذہ کی اسکول کے آس پاس حفاظت کو یقینی بنانے کے لیے نکات۔", icon: <School /> },
      ],
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900" dir={dir} lang={lang}>
      <nav className="bg-red-600 text-white py-3 px-6 flex justify-between items-center">
        <h1 className="font-bold text-xl">HIGHWAYSAFETY</h1>
